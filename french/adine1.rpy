...
translate french adine1_245dbdc1:
    ...
    m "Il se trouve qu'Adine elle même se tenait devant la porte, toute mouillé en tenant les récipients trempés dans sa patte."
...
translate french adine1_ba9efa2f:
    ...
    c "Ils ont changé d'avis, alors je suppose que tu seras coincée avec moi un peu plus longtemps."
...
translate french adine1_7c3e6087:
    ...
    Ad "Je me rappelle de ton nom, cependant. C'était... [player_name], c'est ça?"
...
translate french adine1choice1_e6f972e8:
    ...
    Ad "Il pleut assez fort dehors, c'est tout."
...
translate french adine1choice1_9a5ca63d:
    ...
    Ad "Merci, j'allais justement demander si je pourrais rester un petit moment. C'était ma dernière livraison de la journée et je vit à l'autre bout de la ville."

# game/adine1.rpy:101
translate french adine1choice1_be0b9602:

    # c "Of course, I couldn't let you fly back when it's this ugly outside."
    c "Bien sûr, je ne peux pas te laisser voler chez toi alors qu'il fait si mauvais dehors."

# game/adine1.rpy:105
translate french adine1choice1_8c2647a6:

    # m "I was just about to close the door in her face again when she suddenly spoke up."
    m "J'alais encore lui fermer la porte au nez quand soudainement elle à pris la parole."
...
translate french adine1choice1_f8bbc1ff:
    ...
    Ad "Est-ce tu penses que je peux rentrer quelques minutes? Il pleut assez fort dehors et c'était ma dernière livraison de la journée. Je vis à l'autre bout de la ville et je ne veut pas voler chez moi sous la pluie."
...
translate french menadine_544afc3c:
    ...
    n "Sans un mot de plus, J'ai fermé la porte, avec à présent rien qui ne me séparait des délices de ma nourriture légèrement détrempée."
...
translate french menadine_a00b0992:
    ...
    n "J'ouvrais mon récipient avec anticipation, mais ce qu'il contenait n'était pas du tout ce à quoi je m'attendais. C'était des nouilles, avec du poulet et une sorte de sauce."
...
translate french menadine_68d0fcf9:
    ...
    Ad "Allez, ne me fait pas voler sous la pluie comme ça. S'il te plaît?"
...
translate french _call_skipcheck_10_f212dc62:
    ...
    m "Je m'assis à la table et je commençai à manger alors qu'Adine décidais de s'asseoir en face de moi."

# game/adine1.rpy:260
translate french _call_skipcheck_10_58b7831b:

    # Ad "Do you like it?"
    Ad "Est-ce que tu aimes bien?"
...
translate french _call_skipcheck_10_a47ef0d2:
    ...
    c "Oui. En réalité, c'est presque effrayant comment les choses ici sont proches de ce que'il y a chez moi."

# game/adine1.rpy:272
translate french _call_skipcheck_10_1571c3b3:

    # Ad "Really? Maybe we all just share a similar taste."
    Ad "Vraiment? Peut-être qu'on a tous des goût similaire."
...
translate french _call_skipcheck_10_e241a15e:
    ...
    c "Et bien, ne retraces-tu pas tes origines aux humains d'une manière ou d'une autre? Je sais quelle genre de réputation on a dans votre culture."
...
translate french _call_skipcheck_10_45ce6c6a:
    ...
    c "Laisse moi te poser une question: D'où penses-tu que le portail que vous avez trouvé vienne? Qui l'a construit?"

# game/adine1.rpy:288
translate french _call_skipcheck_10_ef636fcf:

    # Ad "Humans did it, of course."
    Ad "Les humains l'ont fait, bien sûr."
...
translate french _call_skipcheck_10_4ab51b92:
    ...
    c "Exactement. Si vous croyez que les humains ont quelque chose à faire avec un artéfact crée il y a on se pas combien d'années, ce ne serait pas exagéré de dire qu'ils aurait pu vous influencer d'une certaine manière."
...
translate french _call_skipcheck_10_a0052a82:
    ...
    c "Alors, que fais-tu quand tu ne travailles pas au restaurant? As-tu une famille?"

# game/adine1.rpy:303
translate french _call_skipcheck_10_558a112a:

    # Ad "Well, most of the time I take care of my kids."
    Ad "Et bien, la plupart du temps je m'occupe de mes enfants."
...
translate french _call_skipcheck_10_2463bcdc:
    ...
    Ad "En fait ce ne sont pas mes enfants à proprement parler. Je m'occupe juste d'eux."
...
translate french _call_skipcheck_10_4252207b:
    ...
    Ad "Pas tout à fait. Je parle de jeunes orphelins. Je me porte juste volontaire pour passer du temps avec eux, alors je suis plutôt une babysitter et enseignante tout-en-un."
...
translate french _call_skipcheck_10_41444a40:
    ...
    c "Qu'est-ce que tu voudrais savoir?"
...
translate french _call_skipcheck_10_52e199a5:
    ...
    c "Rien de spécial, vraiment. Je veut dire, j'ai mes dîplomes, mais c'est la première fois que je fais quelque chose qui y soit liés. Le travail que je faisais auparavant était juste pour joindre les deux bouts."
...
translate french _call_skipcheck_10_d049fb42:
    ...
    # Ad "Of course it is."
    Ad "Bien sur que ça me concerne."

# game/adine1.rpy:366
translate french _call_skipcheck_10_0cc7643e:

    # c "I suppose it's my turn again, so tell me about your hobbies."
    c "Je suppose que c'est mon encore mon tour, alors parle moi de tes passe-temps."
...
translate french _call_skipcheck_10_4b4db401:
    ...
    Ad "Et bien, pas {i}juste{/i} voler."
...
translate french _call_skipcheck_10_a846bbc7:
    ...
    Ad "C'est à ça que servent les passe-temps, n'est ce pas? C'est juste quelque chose que j'aime faire."
...
translate french _call_skipcheck_10_3a20ab9d:
    ...
    Ad "J'espère faire partie d'une compétition à un moment."

# game/adine1.rpy:399
translate french _call_skipcheck_10_e2d25ad9:

    # Ad "Just because I can fly in the rain doesn't mean that I want to."
    Ad "Juste parce que je peux voler sous la pluie ne veut pas dire que j'en ai envie."
...
translate french _call_skipcheck_10_3a15203a:
    ...
    Ad "Je suppose que ça dépend de si tu seras encore là quand ça va se passer. Ça fait partie d'un festival qu'on fait tous les ans."

# game/adine1.rpy:409
translate french _call_skipcheck_10_410ee6b4:

    # Ad "Okay, since it is my turn again, well..."
    Ad "D'accord, puisque c'est encore mon tour, bon..."
...
translate french _call_skipcheck_10_9beac2da:
    ...
    Ad "Tu sais ce que je veux dire..."
...
translate french _call_skipcheck_10_53f42aeb:
    ...
    c "Je sais. Remy m'a parlé de certaines croyance communes ici."
...
translate french _call_skipcheck_10_ac2a2159:
    ...
    Ad "Je veux dire, ouais, tu as l'air différent, mais tu n'es pas vraiment comme ce que l'ont dit sur votre espèce."
...
translate french _call_skipcheck_10_93f88486:
    ...
    c "Ouais, on a plein de mythes sur les dragons."
...
translate french _call_skipcheck_10_c21eb134:
    ...
    c "Il y en a juste beaucoup trop pour faire une liste. Certain d'entre eux sont bon, d'autres pas vraiment."
...
translate french _call_skipcheck_10_8abc6d5e:
    ...
    Ad "Ça ressemble à ce qu'on a sur vous, en fait. Maintenait que je te vois devant moi, c'est presque ridicule ce que certains mythes dises."
...
translate french _call_skipcheck_10_54e6a0c5:
    ...
    c "Bien, d'après certains d'entre eux, vous êtes des monstres avides, mangeurs d'hommes, et aussi parfois associés au malin et à l'apocalypse."
...
translate french _call_skipcheck_10_fbe98f30:
    ...
    Ad "Cependant pour être honnête, on a des choses sur vous qui ne sont pas très gentilles non plus."

# game/adine1.rpy:458
translate french _call_skipcheck_10_db56dd45:

    # c "Phew, good to know you aren't vicious monsters, then."
    c "Ouf, c'est bon à savoir que vous n'êtes pas des monstres vicieux alors."
...
translate french _call_skipcheck_10_377987b8:
    ...
    c "Ils sont souvent cité comme un symbole de puissance et de force, mais aussi de sagesse, possédant un intellect sans égal. Ce sont de noble créatures et leur représentation bénéficient d'un attrait presque universel."
...
translate french _call_skipcheck_10_d7e7b442:
    ...
    Ad "Je pourrais m'y habituer, bien que ce serait encore mieux si tout était vrai."
...
translate french _call_skipcheck_10_9fd77ad2:
    ...
    Ad "Pour être honnête, je ne sais pas si c'est une bonne idée de généraliser comme ça - même si ce sont de bonnes choses que l'on dit sur nous. On est tous différent, tu sais, et nous ne sommes pas tous gentils."
...
translate french _call_skipcheck_10_c249e3f8:
    ...
    Ad "Quand bien même, ont a dit beaucoup de bonnes choses à propos de vôtre espèce aussi."
...
translate french _call_skipcheck_10_dc481bac:
    ...
    Ad "Tu dis que tu n'as rien de spécial, mais le simple fait que tu sois là avec nous est relativement spécial pour moi et beaucoup d'autres. Essaie juste de voir les choses différemment."

# game/adine1.rpy:482
translate french _call_skipcheck_10_488948a9:

    # c "You know, you have a good point."
    c "C'est vrai, tu as plutôt raison."

# game/adine1.rpy:483
translate french _call_skipcheck_10_161c79f2:

    # Ad "What were you thinking when you first heard about us?"
    Ad "Qu'est-ce que tu pensais quand tu as entendu parler de nous pour la première fois?"
...
translate french _call_skipcheck_10_27b32db1:
    ...
    Ad "Tu vois, quand quelque chose dont tu n'as entendu parler que dans des histoires se trouve être réel, c'est assez spécial."
...
translate french _call_skipcheck_10_aaa0f5f8:
    ...
    c "Je ne savais pas trop quoi en penser. C'était, celà dit, jusqu'a ce que j'arrive ici et que je me retrouve devant l'un d'entre vous. Et après ca, j'était juste bouche bée."

# game/adine1.rpy:498
translate french _call_skipcheck_10_c9851cf8:

    # Ad "Told you so. It was special for you, too!"
    Ad "Je te l'avait dit. C'était spécial pour toi aussi!"
...
translate french _call_skipcheck_10_9cf84c2e:
    ...
    c "Je pensais que faire une découverte de ce genre était juste génial. Beaucoup de gens auraient adoré avoir l'opportunité que j'ai eu en venant ici."
...
translate french _call_skipcheck_10_827a62d3:
    ...
    c "Et ce n'est pas juste la découverte de vous les dragons. On a trouvé un portail vers un monde complètement différent. On a toujours pas compris comment c'est possible."
...
translate french _call_skipcheck_10_5479d226:
    ...
    c "Je suis sûr qu'on va le savoir bien assez tôt."
...
translate french _call_skipcheck_10_ef4c12fa:
    ...
    Ad "Au fait, c'est une sélection intéressante de livres que tu as là. \"Désir Draconique\", \"Sphère Ixomen\" - ils sont à toi?"
...
translate french nextsc_f0510f43:
    ...
    Ad "Il y a eu cette fois quand j'étais encore adolescente. Je m'amusais et je voulais essayer une nouvelle manoeuvre de vol: un tonneau. Inutile de dire que ça s'est mal fini."
...
translate french nextsc_54608f68:
    ...
    Ad "Non, heureusement je n'était pas trop haut lorsque je l'ai fait, et il y avait une flaque de boue là où j'ai attérie. Bien sûr tous mes amis étaient là pour voir ça."

# game/adine1.rpy:781
translate french nextsc_57d8dcd9:

    # c "That wasn't enough to stop you from ever trying again?"
    c "Ça n'a pas suffi pour t'empêcher de réessayer?"

# game/adine1.rpy:783
translate french nextsc_818b4ba1:

    # Ad "No. If anything, it only made me want to try harder."
    Ad "Non. Justement, ça m'a donné envie de m'améliorer."
...
translate french nextsc_646ac1a5:
    ...
    Ad "Ça semble être un voeu très personel, [player_name]."

# game/adine1.rpy:804
translate french nextsc_de415d5c:

    # c "Be rich and have the freedom to do what I want to, whenever I want to."
    c "Être riche et être libre de faire ce que je veux, quand je veux."
...
translate french nextsc_5b659cad:
    ...
    c "En fait, cette question c'est plutôt par rapport à ce que tu ferais si tu avais l'opportunité de faire quelque chose sans qu'on t'attrappe, comme quelque chose d'espiègle ou de criminel."

# game/adine1.rpy:823
translate french nextsc_d89cde73:

    # Ad "Oh, I know what I would do. I'd check out the building they found along with the portal."
    Ad "Oh, je sais ce que je ferais. J'irais voir le bâtiment qui a été découvert en même temps que le portail."
...
translate french nextsc_e950f342:
    ...
    Ad "C'est sous-terrain en fait, et il est fortement gardé pendant qu'une équipe d'archéologues travaille dessus. Je pense qu'il pourrait contenir beaucoup de secrets et de réponses à propos du portail et de son origine."

# game/adine1.rpy:827
translate french nextsc_81939529:

    # c "Interesting. I think I'd like to check that out as well."
    c "Intéressant. Je pense que j'aimerais voir ça aussi."
...
translate french nextsc_6507f194:
    ...
    Ad "Bien, j'ai quelques idées de ce qui pourrait se passer après, mais même si ce que je pense n'est pas vrai, je n'ai pas peur de l'inconnu."
...
translate french nextsc_c1901d4d:
    ...
    Ad "D'un certain côté, je suis un peu curieuse de découvrir comment ce sera quand tout sera terminé."

# game/adine1.rpy:840
translate french nextsc_dace38e7:

    # Ad "Aren't you curious as well?"
    Ad "N'es-tu pas curieux aussi?"

# game/adine1.rpy:841
translate french nextsc_11a66161:

    # c "Not this curious."
    c "Pas si curieux que ça."
...
translate french nextsc_3d75357b:
    ...
    Ad "Si tu savais que le monde était sur le point de s'arrêter, que ferais-tu?"
...
translate french nextsc_d022c5bd:
    ...
    Ad "Bien sûr que j'adorerais visiter - peut-être un peu comme des vacances. Mais si tu veux dire de manière définitive, je ne suis pas sûre que je puisse faire mes bagages et tout laisser derrière moi comme ça."
...
translate french nextsc_a77509ab:
    ...
    Ad "Je crois que c'est le moment pour un défi maintenant."
...
translate french nextsc_dc9a1cef:
    ...
    c "Je me suis dit que j'irais doucement avec toi, vu que c'est ta première fois et tout."
...
translate french _call_syscheck_48_e78a619c:
    ...
    Ad "Alors, je devrais juste prendre une bouchée de celui-la?"
...
translate french _call_syscheck_48_8bc84341:
    ...
    c "Une question. Je ne pouvais juste pas penser à quelque chose de mieux."
...
translate french _call_syscheck_48_30f9f005:
    ...
    Ad "Bien, alors ma réponse serais non. Je n'embrasse pas n'importe qui, tu sais."

# game/adine1.rpy:1043
translate french _call_syscheck_48_5eb2273d:

    # Ad "However, if it was a dare, my answer might be different."
    Ad "Toutefois, si c'était une défi, ma réponse serais peut être différente."
...
translate french _call_syscheck_48_b1f9f1ed:
    ...
    Ad "Bien, alors parmi ceux que tu as rencontré ici pour l'instant, qui est celui que tu aimes le plus?"

# game/adine1.rpy:1196
translate french _call_syscheck_48_ad7dc334:

    # c "I think I'll take a dare for this one."
    c "Je pense que je vais prendre un défi pour celle-là."
...
translate french _call_syscheck_48_7215760e:
    ...
    Ad "D'accord, laisse moi réfléchir une minute."
...
translate french _call_syscheck_48_dc9e044d:
    ...
    Ad "Oups, On dirais que je suis resté plus longtemps que je pensais."

# game/adine1.rpy:1262
translate french _call_syscheck_48_5eb06388:

    # Ad "I probably should be going now."
    Ad "Je devrais probablement partir maintenant."
...
translate french _call_syscheck_48_3d8af9e3:
    ...
    Ad "De toute façon, si tu veux me réinviter chez toi, pourquoi est-ce que je ne te donnerais pas mon numéro personnel et qu'on saute la partie où tu commandes à manger pour me faire venir?"
...
translate french adine1skip_57b8b63d:
    ...
    Ad "Tu sais, si tu veux que je vienne à nouveau, tu n'as pas besoin de commander quoi que ce soit."

# game/adine1.rpy:1351
translate french adine1skip_1f4d0787:

    # Ad "Here's my private number."
    Ad "Voici mon numéro privé."
...
translate french adine1skip_ce4f72ae:
    ...
    Ad "Écoute, je ne veux pas être grossière, mais je pense que ce serait mieux si on reste chacun de notre côté à partir de maintenant. Désolée!"
...
translate french strings:
    ...
    new "Je croyais qu'on était passé à autre chose, mais au moins tu ne me réduis plus à mon espèce."
    ...
    new "Qu'est-ce qui t'es arrivée, tu es tombé dans une rivière ou quoi?"

    # adine1.rpy:92
    old "You're soaked, why don't you come in?"
    new "Tu es trempé, pourquoi ne viens-tu pas à l'intérieur?"
    ...
    new "J'imagine que ça ne ferais pas de mal si tu restais quelques minutes."
    ...
    new "Oui. Je veux sauter en avant."

    # adine1.rpy:212
    old "No. Don't skip ahead."
    new "Non. Ne pas sauter en avant."
    ...
    new "Tu dois être la vouivre livreuse la plus surqualifiée de l'histoire, alors."

    # adine1.rpy:374
    old "That's a cool, but also pretty useless hobby."
    new "C'est un passe temps cool, mais plutôt inutile aussi."
    ...
    new "Alors tu peux faire tout ça, mais un peu de pluie c'est trop?"

    # adine1.rpy:394
    old "Are you that good?"
    new "Tu es si bonne que ça?"

    # adine1.rpy:394
    old "Awesome, where can I watch that?"
    new "Impressionant, où est ce que je peux voir ca?"
    ...
    new "Eh bien, tu t'attendais à quoi?"
    ...
    new "Il y en a beaucoup trop pour compter."
    ...
    # adine1.rpy:485
    old "I was unsure."
    new "Je n'étais pas sûr."

    # adine1.rpy:485
    old "I thought it was awesome."
    new "Je pensais que c'était génial."
    ...
    new "Ce n'est pas tes affaires."

    # adine1.rpy:610
    old "There isn't really anyone."
    new "Il n'y a vraiment personne."
    ...
    new "Désolé, il faut jouer selon les rêgles."
    ...
    new "Quel est la chose la plus embarrasante qui te sois arrivée?"
    ...
    new "Être le meilleur, combattre sans répit."
    ...
    new "Quel est ton plus grand défaut physique selon toi?"
    ...
    new "Pour être hônnete, je ressens la même chose."

    # adine1.rpy:836
    old "You know, if you're so eager to find out, I could help you with that."
    new "Tu sais, si tu es si pressée de savoir, je peux t'aider."

    # adine1.rpy:863
    old "I think they're cute."
    new "Je les trouve mignonnes."
    ...
    new "Faire mes derniers adieux et espérer le meilleur."

    # adine1.rpy:880
    old "Stay outside and watch it all unfold before my eyes."
    new "Rester dehors et tout regarder se dérouler devant mes yeux."
    ...
    new "Si je te demandais de m'embrasser, le ferais-tu?"
